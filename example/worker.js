...
var _user$project$Worker$init = {ctor: '_Tuple2', _0: '', _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$Worker$compiled = _elm_lang$core$Native_Platform.outgoingPort(
	'compiled',
	function (v) {
...
var _user$project$Worker$update = F2(
	function (msg, model) {
		...
		return {
			ctor: '_Tuple2',
			_0: _p1,
			_1: _user$project$Worker$compiled(
				{
					position: _p0._0,
					output: _wende$elchemy$Compiler$tree(_p1)
				})
		};
	});
var _user$project$Worker$compile = _elm_lang$core$Native_Platform.incomingPort(
	'compile',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (position) {
...
var _user$project$Worker$Compile = F2(
	function (a, b) {
...
var _user$project$Worker$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Worker$compile(
				function (_p2) {
					var _p3 = _p2;
					return A2(_user$project$Worker$Compile, _p3.position, _p3.input);
				}),
			_1: {ctor: '[]'}
		});
};
