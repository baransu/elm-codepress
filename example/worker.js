...
var _baransu$elm_codepress$Worker$init = {ctor: '_Tuple2', _0: '', _1: _elm_lang$core$Platform_Cmd$none};
var _baransu$elm_codepress$Worker$compiled = _elm_lang$core$Native_Platform.outgoingPort(
	'compiled',
	function (v) {
		return {position: v.position, output: v.output};
	});
var _baransu$elm_codepress$Worker$update = F2(
	function (msg, model) {
		var _p0 = msg;
		var _p3 = _p0._1;
		var _p2 = _p0._0;
		var command = function () {
			var _p1 = A2(_baransu$elm_codepress$Native_Hacks.tryCatch, _wende$elchemy$Compiler$tree, _p3);
			if (_p1.ctor === 'Ok') {
				return _baransu$elm_codepress$Worker$compiled(
					{position: _p2, output: _p1._0});
			} else {
				return _baransu$elm_codepress$Worker$compiled(
					{position: _p2, output: _p1._0});
			}
		}();
		return {ctor: '_Tuple2', _0: _p3, _1: command};
	});
var _baransu$elm_codepress$Worker$compile = _elm_lang$core$Native_Platform.incomingPort(
	'compile',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (position) {
...
var _baransu$elm_codepress$Worker$Compile = F2(
	function (a, b) {
		return {ctor: 'Compile', _0: a, _1: b};
	});
var _baransu$elm_codepress$Worker$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _baransu$elm_codepress$Worker$compile(
				function (_p4) {
					var _p5 = _p4;
					return A2(_baransu$elm_codepress$Worker$Compile, _p5.position, _p5.input);
				}),
			_1: {ctor: '[]'}
		});
};
var _baransu$elm_codepress$Worker$main = _elm_lang$core$Platform$program(
	{init: _baransu$elm_codepress$Worker$init, update: _baransu$elm_codepress$Worker$update, subscriptions: _baransu$elm_codepress$Worker$subscriptions})();

var Elm = {};
Elm['Worker'] = Elm['Worker'] || {};
if (typeof _baransu$elm_codepress$Worker$main !== 'undefined') {
    _baransu$elm_codepress$Worker$main(Elm['Worker'], 'Worker', undefined);
}
