...
var _user$project$Main$updateCodeRight = F3(
...
var _user$project$Main$updateCodeLeft = F2(
	function (_p2, str) {
		var _p3 = _p2;
		var updateState = function (state) {
			return _elm_lang$core$Native_Utils.update(
...
var _user$project$Main$updateScroll = F3(
...
var _user$project$Main$states = {
	...
	_0: A4(
		...
		{ctor: '_Tuple2', _0: _user$project$Main$left, _1: ''},
...
var _user$project$Main$compile = _elm_lang$core$Native_Platform.outgoingPort(
	'compile',
	function (v) {
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p6.ctor) {
			case 'OnScroll':
				var states = A3(_user$project$Main$updateScroll, model, _p6._0, _p6._1);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'OnInput':
				var _p7 = _p6._0;
				var states = A2(_user$project$Main$updateCodeLeft, model, _p7);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{states: states}),
					_1: _user$project$Main$compile(
						{position: model.position, input: _p7})
				};
			case 'Compiled':
				var states = A3(_user$project$Main$updateCodeRight, model, _p6._0, _p6._1);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
...
var _user$project$Main$batchCompile = _elm_lang$core$Native_Platform.outgoingPort(
	'batchCompile',
	function (v) {
...
var _user$project$Main$compiled = _elm_lang$core$Native_Platform.incomingPort(
	'compiled',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (position) {
...
var _user$project$Main$init = function () {
	var batchData = A2(
		...
		_user$project$Main$states);
	return {
		ctor: '_Tuple2',
		_0: A2(_user$project$Main$Model, 0, _user$project$Main$states),
		_1: _user$project$Main$batchCompile(batchData)
	};
}();
var _user$project$Main$CompileData = F2(
	function (a, b) {
...
var _user$project$Main$options = function (_p10) {
	var _p11 = _p10;
	return {position: _p11.position, states: _p11.states, onScroll: _user$project$Main$OnScroll, onInput: _user$project$Main$OnInput};
};
var _user$project$Main$Compiled = F2(
	function (a, b) {
...
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Main$compiled(
				function (_p12) {
					var _p13 = _p12;
					return A2(_user$project$Main$Compiled, _p13.position, _p13.output);
				}),
			_1: {ctor: '[]'}
		});
};
			...
			_1: {
				...
				_0: function (_p14) {
					return _user$project$Codepress$toHtml(
						_user$project$Main$options(_p14));
				}(model),
				_1: {ctor: '[]'}
			}
		});
